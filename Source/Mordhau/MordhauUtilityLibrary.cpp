...
{}
struct FSteamID UMordhauUtilityLibrary::GetSteamID()
{
	struct FSteamID ReturnValue;
	return ReturnValue;
}
...
{}
class UDecalComponent* UMordhauUtilityLibrary::SpawnBloodDecalAtLocation(class UMaterialInterface* DecalMaterial, const struct FVector& DecalSize, const struct FVector& Location, const struct FRotator& Rotation, float LifeSpan)
{
	return nullptr;
}
...
{}
void UMordhauUtilityLibrary::AwardDuelMMR(struct FSteamID Winner, struct FSteamID Loser, int& NewWinnerMMR, int& NewLoserMMR)
{}
