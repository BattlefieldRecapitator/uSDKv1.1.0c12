...
struct FBoxSphereBounds ReturnFBox;
...
void AMordhauEquipment::SetUseFireArrows(bool UseFire)
{}

struct FEquipmentCustomization AMordhauEquipment::GetRandomCustomization(bool bOnlyColors)
{
	struct FEquipmentCustomization ReturnValue;
	return ReturnValue;
}
...
{
	struct FEquipmentHolsterInfo ReturnValue;
	return ReturnValue;
}
