...
struct FVehicleTransitionInfo AMordhauVehicle::GetVehicleLeaveInfo_Implementation(class AMordhauCharacter* Character, const struct FTransform& FromTransform)
{
	struct FVehicleTransitionInfo ReturnValue;
	return ReturnValue;
}
struct FVehicleTransitionInfo AMordhauVehicle::GetVehicleEnterInfo_Implementation(class AMordhauCharacter* Character, const struct FTransform& FromTransform)
{
	struct FVehicleTransitionInfo ReturnValue;
	return ReturnValue;
}
