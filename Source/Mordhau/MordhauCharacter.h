...
public:
	...
	//AMordhauCharacter::AMordhauCharacter(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Bools")
		bool bCanDodge;
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Bools")
		bool bCanJumpKick;
...
UFUNCTION(BlueprintCallable, Category = "MordhauCharFns")
void AssignNetMotionSimple(EMotionType MotionType, EBlockedReason Param0, uint8 Param1, uint8 Param2);
UFUNCTION(BlueprintCallable, Category = "MordhauCharFns")
void AssignProfile(const struct FCharacterProfile& NewProfile);
