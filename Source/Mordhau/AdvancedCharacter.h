...
bool IsLocallyControlledOrUncontrolled();
	UFUNCTION(BlueprintCallable, Category = "AdvancedCharBoolFns")
bool IsAirborne();
	UFUNCTION(BlueprintPure, BlueprintCallable, Category = "AdvancedCharBoolFns")
static bool GetIsDead();
	UFUNCTION(BlueprintPure, BlueprintCallable, Category = "AdvancedCharBoolFns")
static bool GetIsBurning();
	UFUNCTION(BlueprintCallable, Category = "AdvancedCharBoolFns")
...
float MordhauTakeDamage(float DamageAmount, const struct FHitResult& Hit, EMordhauDamageType DamageType, uint8 DamageSubType, class AActor* Source, class AActor* Agent, class AController* EventInstigator);
	UFUNCTION(BlueprintPure, BlueprintCallable, Category = "AdvancedCharFloatFns")
...
UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "AdvancedCharEvents")
void ReceiveMordhauDamage(float Damage, struct FHitResult HitResult, EMordhauDamageType DamageType, uint8 SubDamageType, class AActor* Source, class AActor* Agent, class AController* EventInstigator);
