...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TSet<class AMordhauPlayerController*> InInstanceWithControllers;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		UCurveFloat* FadeToBlackCurve;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		bool bWantsBlockInput;
	...
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "MordhauControllerFns")
